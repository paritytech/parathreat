...
use constants::{
    accounts::{ALICE, BOB},
    asset_hub_kusama, asset_hub_polkadot, bridge_hub_kusama, bridge_hub_polkadot, casino,
    collectives, kusama, penpal, polkadot,
};
...
decl_test_parachains! {
    ...
    pub struct Casino {
        genesis = casino::genesis(casino::PARA_ID),
        on_init = {
            casino_runtime::AuraExt::on_initialize(1);
        },
        runtime = casino_runtime,
        core = {
            XcmpMessageHandler: casino_runtime::XcmpQueue,
            DmpMessageHandler: casino_runtime::DmpQueue,
            LocationToAccountId: casino_runtime::xcm_config::LocationToAccountId,
            ParachainInfo: casino_runtime::ParachainInfo,
        },
        pallets = {
            PolkadotXcm: casino_runtime::PolkadotXcm,
            Balances: casino_runtime::Balances,
            TransactionPayment: casino_runtime::TransactionPayment,
            RandomnessCollectiveFlip: casino_runtime::RandomnessCollectiveFlip,
            Raffle: casino_runtime::Raffle,
            Poker: casino_runtime::Poker,
            Slots: casino_runtime::Slots,
        }
    },
}
...
impl_accounts_helpers_for_parachain!(Casino);
impl_assert_events_helpers_for_parachain!(Casino);
...
decl_test_sender_receiver_accounts_parameter_types! {
    ...
    Casino { sender: ALICE, receiver: BOB }
}
